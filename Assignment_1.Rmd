...
```
Yes, there is a minor difference between the mean and median. This is most likely the case because the sample of 10 values, while randomly samples, is skewed slightly towards the right -- or the sample contains more values closer to the right end of the sample. This happens because the mean outlines the center of gravity of data set whereas median highlights the middle-most value of the data set.
...
```
```{r, eval=TRUE}
# Create a histogram of the sample values
hist(sample)
```
