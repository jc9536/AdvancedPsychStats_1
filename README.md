...
plot(sample)
```
!(10Plot)[Assignment_1_files/figure-gfm/unnamed-chunk-7-1.png]
...
plot(sample)
```
!(100Plot)[Assignment_1_files/figure-gfm/unnamed-chunk-10-1.png]
...
```
!(CorrPlot)[Assignment_1_files/figure-gfm/unnamed-chunk-17-1.png]
